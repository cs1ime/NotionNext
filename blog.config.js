...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'huaji', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'rev & pwn & dev', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://mapdrv.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 驱动', // 网站关键词 英文逗号隔开
